...
class LocationFinderOnline extends StatefulWidget {
  @override
  _LocationFinderOnlineState createState() => _LocationFinderOnlineState();
}

class _LocationFinderOnlineState extends State<LocationFinderOnline> {
